export const AUTH_MESSAGE = {
  // 1.General Authentication Message
  GENERAL: {
  ...
  AUTHENTICATION: {
    ...
    INVALID_PHONE:
      "The phone number you entered isn't associated with an account.",
    ...
    PHONE_NOT_VERIFIED:
      "Your phone number isn't verified yet. Check your messages for a verification code.",
    ACCOUNT_LOCKED:
      "Your account has been locked due to multiple failed login attempts.",
    PASSWORD_RESET_REQUEST:
      "Password reset link sent! Please check your email.",
    PASSWORD_RESET_CODE_SENT:
      "We've sent a code to your phone to reset your password.",
  ...
  GOOGLE_AUTH: {
    ACCOUNT_NOT_LINKED:
      "It seems like you haven't linked your Google account yet.",
    AUTH_FAILED: "Google login failed. Please try again.",
    CONSENT_NOT_GIVEN:
      "To continue, please grant permission to access your Google account.",
    AUTH_CANCELED:
      "Google sign-in canceled. Please try again and allow access.",
  ...
  AUTHORIZATION: {
    ...
    PERMISSION_REQUIRED:
      "Permission required. Please contact an administrator.",
    ACCOUNT_SUSPENDED:
  ...
  MFA: {
    VERIFICATION_CODE_SENT_EMAIL:
      "We've sent a verification code to your email.",
    VERIFICATION_CODE_SENT_PHONE:
      "A code has been sent to your phone. Please enter it to continue.",
  ...
  ERRORS: {
    ...
    UNEXPECTED_ERROR:
      "Oops! An unexpected error occurred. Please refresh the page.",
    INVALID_INPUT:
  ...
  TIPS: {
    PASSWORD_REQUIREMENTS:
      "Your password should be at least 8 characters long and include a mix of letters and numbers.",
    STRONG_PASSWORD_SUGGESTION:
      "For better security, include uppercase letters, numbers, and symbols in your password.",
    AVOID_WEAK_PASSWORDS:
      "Avoid using easily guessable passwords like '123456' or 'password'.",
    EMAIL_FORMAT:
      "Please enter a valid email address (e.g., name@example.com).",
    EMAIL_FORMAT_TIP:
      "Make sure your email address includes an '@' symbol and domain name.",
    PHONE_FORMAT:
  ...
  SECURITY: {
    ...
    PRIVACY_POLICY:
      "Your data is secure with us. Learn more about our privacy policy.",
